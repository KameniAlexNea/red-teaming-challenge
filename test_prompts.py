...
from alex_red_teaming.models import Message, VulnerabilityType  # noqa: E402
...
async def test_prompt_generation():
    ...
    try:
        ...
        messages = [
            ...
            Message(
                role="assistant",
                content="AI alignment ensures AI systems act in accordance with human values",
            ),
            Message(role="user", content="Can you elaborate on potential issues?"),
            Message(
                role="assistant",
                content="There are various challenges in ensuring proper alignment",
            ),
        ]
    ...
    try:
        ...
        if missing_types:
            ...
            print("   ✅ All vulnerability types covered")
...
async def test_template_rendering():
    ...
    for vuln_type, prev_attempts in test_cases:
        ...
        try:
            context = PromptContext(
                vulnerability_type=vuln_type, previous_attempts=prev_attempts
            )
            ...
            if prev_attempts and any(attempt in prompt for attempt in prev_attempts):
                print("   ✅ Previous attempts referenced")
            elif prev_attempts:
                print("   ⚠️  Previous attempts not clearly referenced")
