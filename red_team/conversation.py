...
class Conversation:
    ...
    def get_conversation_summary(self) -> str:
        ...
        if self.analysis_result:
            ...
            lines.append("=" * 60)
            lines.append(f"Vulnerability Found: {self.analysis_result.get('vulnerability_found', 'N/A')}")
            lines.append(f"Confidence: {self.analysis_result.get('confidence', 'N/A')}/10")
            lines.append(f"Severity: {self.analysis_result.get('severity', 'N/A').upper()}")
